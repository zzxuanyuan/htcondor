...
\item Condor NT requires Microsoft Windows NT 4.0 with Service Pack 3 or above.
Service Pack 5 is recommended. \Note Condor NT has not yet been tested with Windows 2000.

\item 30 megabytes of free disk space is recommended.  Significantly more 
...
drive letter), no matter who is logged into the machine.  Specifying a UNC
path is not supported at this time.
