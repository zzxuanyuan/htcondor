...
\newcommand{\VersionNotice}{Version 6.0.3}
\newcommand{\CopyrightNotice}{Copyright \copyright\ 1990-1998 Condor Team, Computer Sciences Department, 
...
\newcommand{\Macro}[1]{\texttt{#1}}		% Config file macro
\newcommand{\MacroU}[1]{\texttt{\$(#1)}}	% Config file macro's use
