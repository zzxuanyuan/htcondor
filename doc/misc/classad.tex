...
All characters within the delimiter string, plus the space character,
delimit individual strings for a list of strings 
that is given by a single string.
The default delimiter contains the comma and space character.
