...
linked with Condor libaries, users of Condor may be assured that
...
\index{clipped platform!availibility}
...
& pghpf, version 5.0 & Portland Group high performace Fortran compiler \\ 
& pgcc, version 5.0 \\ 
\hline
...
\hline
IRIX 6.5 on Silicon Graphics MIPS (R5000, R8000, and R10000)\\ 
& cc, CC, and c89 \\ 
& f77 and f90 \\ 
& gcc, g++, and g77;  version egcs-1.1.2 for mips4 & We plan to support newer versions of the GNU compiler collection in the near future.  mips4 executables will \emph{not} run on a mips3-only architecture, but
 a mips4 architecture will run a mips3 executable.\\ 
\hline
...
\index{file transfer!large files (>2Gb)}
...
For those platforms where large file transfer is
...
Sun SPARC Sun4m,Sun4c, Sun UltraSPARC with Solaris 2.6, 2.7, 8, 9 & Yes \\ \hline
Silicon Graphics MIPS (R5000, R8000, R10000) with IRIX 6.5 &  Yes \\ \hline
Intel x86 with Red Hat Linux 7.1, 7.2, 7,3, 8.0, 9 & Yes \\ \hline
Intel x86 with Windows 2000 Professional and Server, 2003 Server (Win NT 5.0) & Yes \\ \hline 
...
PowerPC with Macintosh OS X  & No \\ \hline
PowerPC with AIX 5.2L  & Yes \\ \hline
Itanium with Red Hat Linux 7.1, 7.2, 7.3 & Yes \\ \hline
Itanium with SuSE Linux Enterprise 8.1 & Yes \\ \hline
\end{tabular}
\caption{\label{large-file-support}Supported platforms for large file transfer}
\end{table}
\end{center}
...
In addition, there is an e-mail list at condor-world@cs.wisc.edu.  The Condor Team 
uses this e-mail list to announce new releases of Condor and other major Condor-related 
...
too much e-mail as it is, you'll be happy to know that the condor-world e-mail listgroup is 
...
are all welcome; just send Internet e-mail to \URL{mailto:condor-admin@cs.wisc.edu}.  Please include your 
...
The Condor Project will not use these reports to publically
