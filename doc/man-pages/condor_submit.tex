...
called a ``\emph{Substitution Macro}'' that allows you to substitue
...
submit description file: \Macro{executable}, \Macro{environment}, and
\Macro{arguments}. The most common use of this macro is for heterogeneous
