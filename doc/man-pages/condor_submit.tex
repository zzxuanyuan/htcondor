...
\SubmitCmd{globusscheduler} is only required when
the \SubmitCmd{universe} is \SubmitCmd{grid},
and \SubmitCmd{grid\_type} is one of \SubmitCmd{gt2} or \SubmitCmd{gt3}.
...
For a \Arg{grid} universe job, with a \SubmitCmd{grid\_type} of \Arg{condor},
