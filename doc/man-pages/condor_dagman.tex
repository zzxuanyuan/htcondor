...
{metascheduler of the jobs submitted as the nodes of a DAG or DAGs}
...
by specifying multiple \OptArg{-dag} arguments (by passing multiple
DAG files as as command-line arguments to \Condor{submit\_dag}).
