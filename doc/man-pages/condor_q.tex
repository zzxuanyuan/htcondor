...
The \Arg{-better-analyze} option does a more thorough job of determining
why jobs are not running than \Arg{-analyze}.
...
The \Arg{-better-analyze} option make take an excessively long time
to complete in these cases.
Therefore, it is recommended to constrain \Arg{-better-analyze} 
...
\begin{Options}
  ...
  \OptItem{\Opt{-better-analyze}}{Perform a more time-consuming, but
    potentially more extensive analysis to determine
    how many resources are available to run the requested jobs.}
  ...
  \OptItem{\Opt{-globus}}{Get information only about jobs submitted
    ...
    \SubmitCmd{gt3}, or \SubmitCmd{gt4}.}
  ...
  \OptItem{\OptArg{-direct}{rdbms \Bar quilld \Bar schedd}}{When the
    ...
    the rdbms, the \Condor{quill} daemon, or the \Condor{schedd}
    ...
    of Quill. One of the strings \Arg{rdbms}, \Arg{quilld}, or
