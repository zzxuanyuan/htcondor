...
\oOptnm{-pool centralmanagerhostname\oOptnm{:portnumber} $|$ -name scheddname }
$|$
\oOptnm{-addr "\SinfulAny" }
}
...
\OptItem{\OptArg{-pool}{centralmanagerhostname[:portnumber]}}{Specify a pool by giving the
	central manager's hostname and an optional port number}
\OptItem{\OptArg{-name}{scheddname}}{Send the command to a \Condor{schedd} daemon identified by \Opt{scheddname}}
\OptItem{\OptArg{-addr}{"\SinfulAny"}}{Send the command
