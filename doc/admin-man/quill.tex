...
QUILL_DB_TYPE			= "PGSQL"
# The Purage and Reindex intervals are in seconds
...
the other variable \MacroNI{DATABAE\_PURGE\_INTERVAL}
...
\Prog{PostgreSQL} does not aggresively maintain the index structures for
...
variable \MacroNI{DATABAE\_REINDEX\_INTERVAL}.
\MacroNI{DATABASE\_PURGE\_INTERVAL} is set to 86400 seconds, or one day.
