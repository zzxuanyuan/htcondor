...
While Quill works and has been tested with \Prog{PostgreSQL}
versions 7.4 and beyond, we \Bold{strongly recommend} the use of version 
8.1 or 
...
In the case of \Prog{PostgreSQL} 8.1 or later, answer ``no'' to the question
...
\item \Bold{log\_seq\_num} and \Bold{log\_creation\_time}\\
