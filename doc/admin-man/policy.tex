...
Note that in this example, the job ClassAd attribute \MacroNI{IsHighPrioJob}
has no special meaning to Condor.  It just happens to be the name chosen
in this example.  It is therefore up to the user to submit high priority
jobs with something like the following line in the submit file:
\begin{verbatim}
+IsHighPrioJob = True
\end{verbatim}
