...
with an \File{smp.tar} file, a \File{README}, and so on.
The \File{smp.tar} acts much like the \File{release.tar} file for a
main release.
...
You can simply untar the \File{smp.tar} file into your release 
...
should untar the \File{smp.tar} file into some temporary location.
