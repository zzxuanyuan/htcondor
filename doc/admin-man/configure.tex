...
\item[\Macro{NEGOTIATOR\_CYCLE\_DELAY}] \label{param:NegotiatorCycleDelay}
  An integer value that represents the mininum number of seconds
...
(this has been the behavior of DAGMan up to this point).
...
\item 2 = allow terminated/aborted event combination (default)
...
\item[\Macro{HAD\_CONNECTION\_TIMEOUT}]
  ...
  \Condor{had} deamons will incorrectly assume
...
this includes transfer attemps on the primary protocol and all
...
Units = minutes, default value = 10, minumum value = 1.
