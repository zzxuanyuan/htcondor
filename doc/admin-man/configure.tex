...
\item[\Macro{EXECUTE}] \label{param:Execute} This directory acts as
  ...
  (or this macro defined).  Normally, \MacroNI{EXECUTE} is defined
...
\item[\Macro{APPEND\_REQUREMENTS}] \label{param:AppendReq}
  ...
  is defined, then ignore the \MacroNI{APPEND\_REQUREMENTS} for those
  universes.
...
\label{param:GridmanagerMaxPendingSubmits} The maximum number of jobs
...
%\label{param:GridmanagerRestartOnAnyDownResources} To be written...

%\item[\Macro{GRIDMANAGER\_MAX\_TIME\_DOWN\_RESOURCES}]
%\label{param:GridmanagerMaxTimeDownResources} To be written...
