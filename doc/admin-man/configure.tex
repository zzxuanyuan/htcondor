...
parallel universe).  If the DAG references such a submit file, the
DAG will abort during the initialization process.  If undefined,
\Macro{DAGMAN\_PROHIBIT\_MULTI\_JOBS} defaults to \Expr{False}.
