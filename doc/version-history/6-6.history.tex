...
\item A command-line argument that begins with \Opt{-d}
for \Condor{checkpoint}, \Condor{off}, \Condor{on},
\Condor{reconfig}, \Condor{reschedule}, \Condor{restart} and \Condor{vacate}
causes the command to be sent to a local daemon.
