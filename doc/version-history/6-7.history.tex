...
\item The \Opt{-name} option to \Condor{submit} now works on Windows
  platforms. 
...
\item Fixed a bug in \Condor{dagman} which would cause a node's POST script not to be run
...
submitted due to repeated \Condor{submit} failures.
