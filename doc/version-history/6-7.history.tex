...
% NOTE FOR V6_7_20-branch -> V6_7-branch MERGE: THIS ENTRY HAS BEEN COPIED
% HERE FROM V6_7-branch, SINCE IT WAS INCORRECTLY COMMITTED THERE ORIGINALLY.
% PLEASE MAKE SURE IT IS NOT DUPLICATED AFTER THE MERGE.
