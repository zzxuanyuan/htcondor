...
\item Added a clipped port for SuSE Enterprise Linux Server 9 running on the 
...
\item SuSE Enterprise Linux Server 9 on PowerPC only: The default Java
interpreter on SuSE Enterprise Linux Server 9 running on the PowerPC
