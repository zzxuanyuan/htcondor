...
\Note Condor-PVM is an optional Condor module.  To check and see if
...
file ``condor\_pvmd'' on your system, Condor-PVM is installed.  
If not, ask your site administrator to download Condor-PVM from
\Url{http://www.cs.wisc.edu/condor} in the ``contrib'' section of the 
