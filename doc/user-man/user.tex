...
receives his fair share of machines.  (Note that setting
\Macro{PREEMPTION\_REQUIREMENTS} does not influence other forms of preemption,
such as startd \MacroNI{RANK} or \MacroNI{PREEMPT}.  See section
\ref{sec:Disabling Preemption} for a general discussion of
limiting preemption.)
