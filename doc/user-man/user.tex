...
to the directory where the job was submitted.
For the other cases, files are transferred back to 
the directory defined by the configuration
variable \MacroNI{SPOOL}. 
These files are named using the \Attr{ClusterId} and \Attr{ProcId}
