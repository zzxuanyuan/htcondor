...
It may specify eight types of items:
\begin{enumerate}
\item
...
The optional \Arg{DIR} specification tells \Condor{dagman} to
change to the given directory when running the \Arg{PRE} and
\Arg{POST} scripts and submitting the Condor job for this node.
...
command line (e.g., \MacroNI{DAGMAN\_MAX\_JOBS\_SUBMITTED}/
\OptArg{-maxjobs}).
\end{enumerate}
