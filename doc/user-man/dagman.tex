...
The input file used by DAGMan specifies eight items:
\begin{enumerate}
\item
A list of the jobs in the DAG. This serves to name each job
and specify each job's Condor submit description file.
\item
