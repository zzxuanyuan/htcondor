...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Why do standard universe jobs never run after the upgrade?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
There are two possibilities for these standard universe jobs that
...
\begin{enumerate}
  ...
  \item Utilize the platform information from the machine when the
  job last produced a checkpoint together with knowledge of the
  needed \Attr{LastCheckpointPlatform} attribute to form a value.
  Add this attribute to the job's ClassAd using \Condor{qedit}.
\end{enumerate}
