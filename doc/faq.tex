...
It makes sense to install Personal Condor on a single machine
within an organization for Condor-G functionality.
...
Do I need to install Globus and use Condor-G?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
all Condor features continue to work,
such as use of the standard universe for
