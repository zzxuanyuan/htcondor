...
set CONDOR_TESTS_INCLUDE=/I "..\..\src\h" /I "..\..\src\condor_includes" /I "..\..\src\condor_c++_util" /I "..\..\src\condor_daemon_client" /I "..\..\src\condor_daemon_core.V6" /I "..\..\src\condor_schedd.V6" /I "..\..\src\condor_classad.V6" /I "..\..\src\ccb"
