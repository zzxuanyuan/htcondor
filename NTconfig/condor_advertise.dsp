# Microsoft Developer Studio Project File - Name="condor_advertise" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "condor_advertise.mak".
!MESSAGE 
...
# ADD CPP /nologo /MTd /W3 /Gm /Gi /GX /ZI /Od $(CONDOR_INCLUDE) $(CONDOR_GSOAP_INCLUDE) $(CONDOR_GLOBUS_INCLUDE) $(CONDOR_OPENSSL_INCLUDE) $(CONDOR_POSTGRESQL_INCLUDE) $(CONDOR_KERB_INCLUDE) $(CONDOR_PCRE_INCLUDE) /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"..\Debug\condor_common.pch" /Yu"condor_common.h" /FD /TP /c
...
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "condor_advertise___Win32_Release"
# PROP BASE Intermediate_Dir "condor_advertise___Win32_Release"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib mswsock.lib netapi32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept
...
# Name "condor_advertise - Win32 Debug"
# Name "condor_advertise - Win32 Release"
# Begin Source File

SOURCE=..\src\condor_tools\advertise.cc
# End Source File
# Begin Source File
