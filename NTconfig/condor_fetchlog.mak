# Microsoft Developer Studio Generated NMAKE File, Based on condor_fetchlog.dsp
!IF "$(CFG)" == ""
CFG=condor_fetchlog - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_fetchlog - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_fetchlog - Win32 Debug" && "$(CFG)" != "condor_fetchlog - Win32 Release"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_fetchlog.mak" CFG="condor_fetchlog - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "condor_fetchlog - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE "condor_fetchlog - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "condor_fetchlog - Win32 Debug"
...
ALL : "$(OUTDIR)\condor_fetchlog.exe"

!ELSE 

ALL : "condor_util_lib - Win32 Debug" "condor_sysapi - Win32 Debug" "condor_io - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_classad - Win32 Debug" "$(OUTDIR)\condor_fetchlog.exe"
...
!ENDIF 
	...
	-@erase "$(INTDIR)\fetch_log.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(OUTDIR)\condor_fetchlog.exe"
	-@erase "$(OUTDIR)\condor_fetchlog.ilk"
	-@erase "$(OUTDIR)\condor_fetchlog.pdb"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_fetchlog.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_fetchlog.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_fetchlog.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\fetch_log.obj" \
...
"$(OUTDIR)\condor_fetchlog.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "condor_fetchlog - Win32 Release"
...
ALL : "condor_util_lib - Win32 Release" "condor_sysapi - Win32 Release" "condor_io - Win32 Release" "condor_cpp_util - Win32 Release" "condor_classad - Win32 Release" "$(OUTDIR)\condor_fetchlog.exe"
...
!ENDIF 
	...
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(OUTDIR)\condor_fetchlog.exe"
	-@erase "$(OUTDIR)\condor_fetchlog.map"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ..\Release\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_fetchlog.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_fetchlog.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\fetch_log.obj" \
	"$(OUTDIR)\condor_classad.lib" \
...
!IF EXISTS("condor_fetchlog.dep")
!INCLUDE "condor_fetchlog.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_fetchlog.dep"
!ENDIF 
!ENDIF 
...
SOURCE=..\src\condor_tools\fetch_log.C

"$(INTDIR)\fetch_log.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
