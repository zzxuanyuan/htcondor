# Microsoft Developer Studio Generated NMAKE File, Based on condor_q.dsp
!IF "$(CFG)" == ""
CFG=condor_q - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_q - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_q - Win32 Debug" && "$(CFG)" != "condor_q - Win32 Release"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_q.mak" CFG="condor_q - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "condor_q - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE "condor_q - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
ALL : "$(OUTDIR)\condor_q.exe"

!ELSE 

ALL : "condor_sysapi - Win32 Debug" "condor_qmgmt - Win32 Debug" "condor_io - Win32 Debug" "condor_classad - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_util_lib - Win32 Debug" "$(OUTDIR)\condor_q.exe"
...
!ENDIF 
	...
	-@erase "$(OUTDIR)\condor_q.exe"
	-@erase "$(OUTDIR)\condor_q.ilk"
	-@erase "$(OUTDIR)\condor_q.pdb"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_q.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_q.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_q.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\queue.obj" \
...
"$(OUTDIR)\condor_q.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "condor_q - Win32 Release"
...
ALL : "condor_sysapi - Win32 Release" "condor_qmgmt - Win32 Release" "condor_io - Win32 Release" "condor_classad - Win32 Release" "condor_cpp_util - Win32 Release" "condor_util_lib - Win32 Release" "$(OUTDIR)\condor_q.exe"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_q.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_q.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\queue.obj" \
	"..\src\condor_util_lib\condor_util.lib" \
...
!IF EXISTS("condor_q.dep")
!INCLUDE "condor_q.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_q.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\queue.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
