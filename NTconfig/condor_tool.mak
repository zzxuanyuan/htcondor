# Microsoft Developer Studio Generated NMAKE File, Based on condor_tool.dsp
!IF "$(CFG)" == ""
CFG=condor_tool - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_tool - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_tool - Win32 Debug" && "$(CFG)" != "condor_tool - Win32 Release"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_tool.mak" CFG="condor_tool - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "condor_tool - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE "condor_tool - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "condor_tool - Win32 Debug"
...
ALL : "$(OUTDIR)\condor.exe"

!ELSE 

ALL : "condor_sysapi - Win32 Debug" "condor_classad - Win32 Debug" "condor_io - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_util_lib - Win32 Debug" "$(OUTDIR)\condor.exe"
...
!ENDIF 
	...
	-@erase "$(OUTDIR)\condor.ilk"
	-@erase "$(OUTDIR)\condor.pdb"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_tool.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\tool.obj" \
...
!ELSEIF  "$(CFG)" == "condor_tool - Win32 Release"
...
ALL : "condor_sysapi - Win32 Release" "condor_classad - Win32 Release" "condor_io - Win32 Release" "condor_cpp_util - Win32 Release" "condor_util_lib - Win32 Release" "$(OUTDIR)\condor.exe"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor.map" /debug /machine:I386 /out:"$(OUTDIR)\condor.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\tool.obj" \
	"..\src\condor_util_lib\condor_util.lib" \
...
!IF EXISTS("condor_tool.dep")
!INCLUDE "condor_tool.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_tool.dep"
!ENDIF 
!ENDIF 
