...
!IF "$(CFG)" == ""
CFG=condor_stats - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_stats - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_stats - Win32 Debug" && "$(CFG)" != "condor_stats - Win32 Release"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_stats.mak" CFG="condor_stats - Win32 Release"
!MESSAGE 
...
!IF  "$(CFG)" == "condor_stats - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_stats.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_stats.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\stats.obj" \
...
!ELSEIF  "$(CFG)" == "condor_stats - Win32 Release"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_stats.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_stats.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\stats.obj" \
	"$(OUTDIR)\condor_cpp_util.lib" \
...
"$(INTDIR)\stats.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
