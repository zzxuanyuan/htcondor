...
!IF "$(CFG)" == ""
CFG=condor_prio - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_prio - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_prio - Win32 Debug" && "$(CFG)" != "condor_prio - Win32 Release"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_prio.mak" CFG="condor_prio - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "condor_prio - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE "condor_prio - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "condor_prio - Win32 Debug"
...
ALL : "condor_qmgmt - Win32 Debug" "condor_sysapi - Win32 Debug" "condor_io - Win32 Debug" "condor_classad - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_util_lib - Win32 Debug" "$(OUTDIR)\condor_prio.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_util_lib - Win32 DebugCLEAN" "condor_cpp_util - Win32 DebugCLEAN" "condor_classad - Win32 DebugCLEAN" "condor_io - Win32 DebugCLEAN" "condor_sysapi - Win32 DebugCLEAN" "condor_qmgmt - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
...
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_prio.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_prio.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\prio.obj" \
...
!ELSEIF  "$(CFG)" == "condor_prio - Win32 Release"
...
ALL : "condor_qmgmt - Win32 Release" "condor_sysapi - Win32 Release" "condor_io - Win32 Release" "condor_classad - Win32 Release" "condor_cpp_util - Win32 Release" "condor_util_lib - Win32 Release" "$(OUTDIR)\condor_prio.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_util_lib - Win32 ReleaseCLEAN" "condor_cpp_util - Win32 ReleaseCLEAN" "condor_classad - Win32 ReleaseCLEAN" "condor_io - Win32 ReleaseCLEAN" "condor_sysapi - Win32 ReleaseCLEAN" "condor_qmgmt - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\dc_stub.obj"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_prio.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_prio.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\prio.obj" \
	"..\src\condor_util_lib\condor_util.lib" \
...
!IF EXISTS("condor_prio.dep")
!INCLUDE "condor_prio.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_prio.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\prio.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
