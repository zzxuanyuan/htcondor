...
gridmanager : $(SRCDIR)\condor_$@\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
	copy /Y $(TEMPDIR)\soap_$@C.cpp      .\*.cc
	copy /Y $(TEMPDIR)\soap_$@Server.cpp .\*.cc
...
dagman : $(SRCDIR)\condor_$@\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
starter : $(SRCDIR)\condor_$@.V6.1\soap_$@Stub.cc \
...
shadow : $(SRCDIR)\condor_$@.V6.1\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@.V6.1\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@.V6.1
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
startd : $(SRCDIR)\condor_$@.V6\soap_$@Stub.cc \
...
collector : $(SRCDIR)\condor_$@.V6\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@.V6\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@.V6
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
schedd : $(SRCDIR)\condor_$@.V6\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@.V6\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@.V6
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
negotiator : $(SRCDIR)\condor_$@.V6\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@.V6\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@.V6
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
master : $(SRCDIR)\condor_$@.V6\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@.V6\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@.V6
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
cgahp : $(SRCDIR)\condor_c-gahp\soap_$@Stub.cc \
...
cgahp_worker : $(SRCDIR)\condor_c-gahp\soap_$@Stub.cc \
			$(SRCDIR)\condor_c-gahp\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_c-gahp
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
quill : $(SRCDIR)\condor_$@\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
credd : $(SRCDIR)\condor_$@\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
had : $(SRCDIR)\condor_$@\soap_$@Stub.cc \
			$(SRCDIR)\condor_$@\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_$@
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
replication : $(SRCDIR)\condor_had\soap_$@Stub.cc \
...
transferer : $(SRCDIR)\condor_had\soap_$@Stub.cc \
			$(SRCDIR)\condor_had\gsoap_$@.h
	-2mkdir $(TEMPDIR)
	cd $(SRCDIR)\condor_had
	$(SOAPCPP) $(SOAPCPPFLAGS) -p soap_$@ -d $(TEMPDIR) gsoap_$@.h
...
vmgahp : $(SRCDIR)\condor_vm-gahp\soap_$@Stub.cc \
...
dbmsd : $(SRCDIR)\condor_dbmsd\soap_$@Stub.cc \
