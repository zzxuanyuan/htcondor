# Microsoft Developer Studio Project File - Name="condor_transfer_data" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "condor_transfer_data.mak".
!MESSAGE 
...
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "condor_transfer_data___Win32_Release"
# PROP BASE Intermediate_Dir "condor_transfer_data___Win32_Release"
...
# ADD CPP /nologo /MT /W3 /GX /Z7 /O1 /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"..\Release\condor_common.pch" /Yu"condor_common.h" $(CONDOR_INCLUDE) $(CONDOR_DEFINES) $(CONDOR_CPPARGS) $(CONDOR_GSOAP_INCLUDE) $(CONDOR_GLOBUS_INCLUDE) $(CONDOR_KERB_INCLUDE) $(CONDOR_PCRE_INCLUDE) $(CONDOR_OPENSSL_INCLUDE) $(CONDOR_POSTGRESQL_INCLUDE) /FD /TP /c
# ADD BASE RSC /l 0x409 /d "_DEBUG"
...
# Name "condor_transfer_data - Win32 Debug"
# Name "condor_transfer_data - Win32 Release"
# Begin Source File
...
SOURCE=..\src\condor_tools\transfer_data.cpp
# End Source File
# End Target
# End Project
