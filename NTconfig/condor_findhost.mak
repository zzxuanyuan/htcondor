# Microsoft Developer Studio Generated NMAKE File, Based on condor_findhost.dsp
!IF "$(CFG)" == ""
CFG=condor_findhost - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_findhost - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_findhost - Win32 Debug" && "$(CFG)" != "condor_findhost - Win32 Release"
...
ALL : "$(OUTDIR)\condor_findhost.exe"

!ELSE 

ALL : "condor_util_lib - Win32 Debug" "condor_sysapi - Win32 Debug" "condor_io - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_classad - Win32 Debug" "$(OUTDIR)\condor_findhost.exe"
...
!ENDIF 
	...
	-@erase "$(OUTDIR)\condor_findhost.exe"
	-@erase "$(OUTDIR)\condor_findhost.ilk"
	-@erase "$(OUTDIR)\condor_findhost.pdb"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_findhost.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_findhost.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_findhost.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
...
"$(OUTDIR)\condor_findhost.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "condor_util_lib - Win32 Release" "condor_sysapi - Win32 Release" "condor_io - Win32 Release" "condor_cpp_util - Win32 Release" "condor_classad - Win32 Release" "$(OUTDIR)\condor_findhost.exe"
...
!ENDIF 
	...
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(OUTDIR)\condor_findhost.exe"
	-@erase "$(OUTDIR)\condor_findhost.map"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ..\Release\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_findhost.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_findhost.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\give_interactive.obj" \
	"$(OUTDIR)\condor_classad.lib" \
...
!IF EXISTS("condor_findhost.dep")
!INCLUDE "condor_findhost.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_findhost.dep"
!ENDIF 
!ENDIF 
