# Microsoft Developer Studio Project File - Name="condor_tool" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "condor_tool.mak".
!MESSAGE 
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 /nologo /subsystem:console /debug /machine:I386 /out:"../src/condor_tools/condor.exe" /pdbtype:sept
# ADD LINK32 ../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) $(CONDOR_GLOBUS_LIB) $(CONDOR_GLOBUS_LIBPATH) $(CONDOR_OPENSSL_LIB) $(CONDOR_POSTGRESQL_LIB) $(CONDOR_OPENSSL_LIBPATH) $(CONDOR_POSTGRESQL_LIBPATH) /nologo /subsystem:console /pdb:none /map /debug /machine:I386 /out:"..\Release\condor.exe"

!ENDIF 

# Begin Target

# Name "condor_tool - Win32 Debug"
...
SOURCE=..\src\condor_tools\tool.cc
# End Source File
# End Target
# End Project
