# Microsoft Developer Studio Generated NMAKE File, Based on condor_power.dsp
!IF "$(CFG)" == ""
CFG=condor_power - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_power - Win32 Release.
!ENDIF 
...
!MESSAGE 
!MESSAGE NMAKE /f "condor_power.mak" CFG="condor_power - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "condor_power - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE "condor_power - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
CLEAN :
!ENDIF 
	-@erase "$(OUTDIR)\condor_power.exe"
	-@erase "$(OUTDIR)\condor_power.ilk"
	-@erase "$(OUTDIR)\condor_power.pdb"
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_power.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) $(CONDOR_GLOBUS_LIB) $(CONDOR_GLOBUS_LIBPATH) $(CONDOR_OPENSSL_LIB) $(CONDOR_POSTGRESQL_LIB) $(CONDOR_OPENSSL_LIBPATH) $(CONDOR_POSTGRESQL_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_power.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_power.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(OUTDIR)\condor_io.lib" \
	"$(OUTDIR)\condor_sysapi.lib" \
	"..\src\condor_util_lib\condor_util.lib"

"$(OUTDIR)\condor_power.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) $(CONDOR_GLOBUS_LIB) $(CONDOR_GLOBUS_LIBPATH) $(CONDOR_OPENSSL_LIB) $(CONDOR_POSTGRESQL_LIB) $(CONDOR_OPENSSL_LIBPATH) $(CONDOR_POSTGRESQL_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_power.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_power.exe" 
LINK32_OBJS= \
	"$(OUTDIR)\condor_io.lib" \
	"$(OUTDIR)\condor_sysapi.lib" \
	"..\src\condor_util_lib\condor_util.lib"
...
!IF EXISTS("condor_power.dep")
!INCLUDE "condor_power.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_power.dep"
!ENDIF 
!ENDIF 
