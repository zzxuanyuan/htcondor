...
"$(INTDIR)\soap_negotiatorC.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_negotiatorC.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_negotiator.V6\soap_negotiatorStub.h"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_negotiatorServer.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_negotiatorServer.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_negotiator.V6\soap_negotiatorStub.h"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_negotiatorStub.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_negotiatorStub.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_negotiator.V6\soap_negotiatorStub.h"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
InputDir=..\src\condor_negotiator.V6
InputPath=..\src\condor_negotiator.V6\soap_negotiatorStub.h

"..\src\condor_negotiator.V6\soap_negotiatorC.C" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	<<tempfile.bat 
	@echo off 
	cd $(InputDir) 
	soap_gen negotiator 
