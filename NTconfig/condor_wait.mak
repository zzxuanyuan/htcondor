# Microsoft Developer Studio Generated NMAKE File, Based on condor_wait.dsp
!IF "$(CFG)" == ""
CFG=condor_wait - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_wait - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_wait - Win32 Debug" && "$(CFG)" != "condor_wait - Win32 Release"
...
ALL : "$(OUTDIR)\condor_wait.exe"

!ELSE 

ALL : "condor_sysapi - Win32 Debug" "condor_io - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_classad - Win32 Debug" "condor_util_lib - Win32 Debug" "$(OUTDIR)\condor_wait.exe"
...
!ENDIF 
	...
	-@erase "$(OUTDIR)\condor_wait.exe"
	-@erase "$(OUTDIR)\condor_wait.ilk"
	-@erase "$(OUTDIR)\condor_wait.pdb"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_wait.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_wait.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_wait.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\wait.obj" \
...
"$(OUTDIR)\condor_wait.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "condor_sysapi - Win32 Release" "condor_io - Win32 Release" "condor_cpp_util - Win32 Release" "condor_classad - Win32 Release" "condor_util_lib - Win32 Release" "$(OUTDIR)\condor_wait.exe"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_wait.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_wait.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\wait.obj" \
	"..\src\condor_util_lib\condor_util.lib" \
...
!IF EXISTS("condor_wait.dep")
!INCLUDE "condor_wait.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_wait.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\wait.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
