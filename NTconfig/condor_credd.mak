# Microsoft Developer Studio Generated NMAKE File, Based on condor_credd.dsp
!IF "$(CFG)" == ""
CFG=condor_credd - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_credd - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_credd - Win32 Debug" && "$(CFG)" != "condor_credd - Win32 Release"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_credd.mak" CFG="condor_credd - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "condor_credd - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE "condor_credd - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "condor_credd - Win32 Debug"
...
ALL : "$(OUTDIR)\condor_credd.exe"

!ELSE 

ALL : "condor_privsep_client - Win32 Debug" "condor_procd_client - Win32 Debug" "condor_util_lib - Win32 Debug" "condor_sysapi - Win32 Debug" "condor_procapi - Win32 Debug" "condor_io - Win32 Debug" "condor_daemon_core - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_classad - Win32 Debug" "$(OUTDIR)\condor_credd.exe"
...
CLEAN :
!ENDIF 
	-@erase "$(OUTDIR)\condor_credd.exe"
	-@erase "$(OUTDIR)\condor_credd.ilk"
	-@erase "$(OUTDIR)\condor_credd.pdb"
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_credd.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) $(CONDOR_GLOBUS_LIB) $(CONDOR_GLOBUS_LIBPATH) $(CONDOR_OPENSSL_LIB) $(CONDOR_POSTGRESQL_LIB) $(CONDOR_OPENSSL_LIBPATH) $(CONDOR_POSTGRESQL_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_credd.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_credd.exe" /pdbtype:sept 
LINK32_OBJS= \
...
"$(OUTDIR)\condor_credd.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "condor_credd - Win32 Release"
...
ALL : "condor_privsep_client - Win32 Release" "condor_procd_client - Win32 Release" "condor_util_lib - Win32 Release" "condor_sysapi - Win32 Release" "condor_procapi - Win32 Release" "condor_io - Win32 Release" "condor_daemon_core - Win32 Release" "condor_cpp_util - Win32 Release" "condor_classad - Win32 Release" "$(OUTDIR)\condor_credd.exe"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) $(CONDOR_GLOBUS_LIB) $(CONDOR_GLOBUS_LIBPATH) $(CONDOR_OPENSSL_LIB) $(CONDOR_POSTGRESQL_LIB) $(CONDOR_OPENSSL_LIBPATH) $(CONDOR_POSTGRESQL_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_credd.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_credd.exe" 
LINK32_OBJS= \
	"$(OUTDIR)\condor_daemon_core.lib" \
	"$(OUTDIR)\condor_io.lib" \
	"$(OUTDIR)\condor_sysapi.lib" \
...
!IF EXISTS("condor_credd.dep")
!INCLUDE "condor_credd.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_credd.dep"
!ENDIF 
!ENDIF 
