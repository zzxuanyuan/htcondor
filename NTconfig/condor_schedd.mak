...
"$(INTDIR)\soap_scheddC.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_schedd.V6\soap_scheddStub.h"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_scheddServer.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_schedd.V6\soap_scheddStub.h"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
InputPath=..\src\condor_schedd.V6\soap_scheddStub.h
