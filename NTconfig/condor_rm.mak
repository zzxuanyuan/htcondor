# Microsoft Developer Studio Generated NMAKE File, Based on condor_rm.dsp
!IF "$(CFG)" == ""
CFG=condor_rm - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_rm - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_rm - Win32 Debug" && "$(CFG)" != "condor_rm - Win32 Release"
...
ALL : "$(OUTDIR)\condor_rm.exe"

!ELSE 

ALL : "condor_sysapi - Win32 Debug" "condor_classad - Win32 Debug" "condor_io - Win32 Debug" "condor_qmgmt - Win32 Debug" "condor_cpp_util - Win32 Debug" "condor_util_lib - Win32 Debug" "$(OUTDIR)\condor_rm.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_util_lib - Win32 DebugCLEAN" "condor_cpp_util - Win32 DebugCLEAN" "condor_qmgmt - Win32 DebugCLEAN" "condor_io - Win32 DebugCLEAN" "condor_classad - Win32 DebugCLEAN" "condor_sysapi - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	...
	-@erase "$(OUTDIR)\condor_rm.exe"
	-@erase "$(OUTDIR)\condor_rm.ilk"
	-@erase "$(OUTDIR)\condor_rm.pdb"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_rm.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_rm.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_rm.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\rm.obj" \
...
"$(OUTDIR)\condor_rm.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "condor_sysapi - Win32 Release" "condor_classad - Win32 Release" "condor_io - Win32 Release" "condor_qmgmt - Win32 Release" "condor_cpp_util - Win32 Release" "condor_util_lib - Win32 Release" "$(OUTDIR)\condor_rm.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_util_lib - Win32 ReleaseCLEAN" "condor_cpp_util - Win32 ReleaseCLEAN" "condor_qmgmt - Win32 ReleaseCLEAN" "condor_io - Win32 ReleaseCLEAN" "condor_classad - Win32 ReleaseCLEAN" "condor_sysapi - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\dc_stub.obj"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_rm.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_rm.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\rm.obj" \
	"..\src\condor_util_lib\condor_util.lib" \
...
!IF EXISTS("condor_rm.dep")
!INCLUDE "condor_rm.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_rm.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\rm.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
