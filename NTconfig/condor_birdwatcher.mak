...
"$(INTDIR)\birdwatcher.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\birdwatcher.res" /i "\scratch\pavlo\V6_7-cron-4-branch\src\condor_birdwatcher" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\birdwatcher.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\birdwatcher.res" /i "\scratch\pavlo\V6_7-cron-4-branch\src\condor_birdwatcher" /d "_DEBUG" $(SOURCE)
