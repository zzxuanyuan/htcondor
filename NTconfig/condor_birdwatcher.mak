...
"$(INTDIR)\birdwatcher.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\birdwatcher.res" /i "\burnett\V6_9-quillpp-8-branch\src\condor_birdwatcher" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\birdwatcher.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\birdwatcher.res" /i "\burnett\V6_9-quillpp-8-branch\src\condor_birdwatcher" /d "_DEBUG" $(SOURCE)
