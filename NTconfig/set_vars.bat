...
set EXT_KERBEROS_VERSION=krb5-1.4
set EXT_GLOBUS_VERSION=
set EXT_OPENSSL_VERSION=openssl-0.9.7e

REM Now tell the build system what externals we need built.
set EXTERNALS_NEEDED=%EXT_GSOAP_VERSION% %EXT_KERBEROS_VERSION% %EXT_GLOBUS_VERSION% %EXT_OPENSSL_VERSION%
...
set CONDOR_OPENSSL_LIBPATH=/LIBPATH:%EXT_INSTALL%\%EXT_OPENSSL_VERSION%
