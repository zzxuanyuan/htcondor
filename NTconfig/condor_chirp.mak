...
ALL : "condor_chirp_client - Win32 Debug" "$(OUTDIR)\condor_chirp.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_chirp_client - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
...
ALL : "condor_chirp_client - Win32 Release" "$(OUTDIR)\condor_chirp.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_chirp_client - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\condor_chirp.obj"
