...
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_collector.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_collector.exe" /pdbtype:sept 
LINK32_OBJS= \
...
"$(INTDIR)\soap_collectorC.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_collector.V6\soap_collectorStub.h"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_collectorServer.obj" : $(SOURCE) "$(INTDIR)" "..\src\condor_collector.V6\soap_collectorStub.h"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
"$(INTDIR)\soap_collectorStub.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch" "..\src\condor_collector.V6\soap_collectorStub.h"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
