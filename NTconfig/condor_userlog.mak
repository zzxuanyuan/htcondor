# Microsoft Developer Studio Generated NMAKE File, Based on condor_userlog.dsp
!IF "$(CFG)" == ""
CFG=condor_userlog - Win32 Release
!MESSAGE No configuration specified. Defaulting to condor_userlog - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "condor_userlog - Win32 Debug" && "$(CFG)" != "condor_userlog - Win32 Release"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "condor_userlog.mak" CFG="condor_userlog - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "condor_userlog - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE "condor_userlog - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "condor_userlog - Win32 Debug"
...
ALL : "$(OUTDIR)\condor_userlog.exe"

!ELSE 

ALL : "condor_classad - Win32 Debug" "condor_sysapi - Win32 Debug" "condor_io - Win32 Debug" "condor_util_lib - Win32 Debug" "condor_cpp_util - Win32 Debug" "$(OUTDIR)\condor_userlog.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_cpp_util - Win32 DebugCLEAN" "condor_util_lib - Win32 DebugCLEAN" "condor_io - Win32 DebugCLEAN" "condor_sysapi - Win32 DebugCLEAN" "condor_classad - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\dc_stub.obj"
	-@erase "$(INTDIR)\userlog.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(OUTDIR)\condor_userlog.exe"
	-@erase "$(OUTDIR)\condor_userlog.ilk"
	-@erase "$(OUTDIR)\condor_userlog.pdb"
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\condor_userlog.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=../Debug/condor_common.obj ..\Debug\condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\condor_userlog.pdb" /debug /machine:I386 /out:"$(OUTDIR)\condor_userlog.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\userlog.obj" \
...
"$(OUTDIR)\condor_userlog.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "condor_userlog - Win32 Release"
...
ALL : "condor_classad - Win32 Release" "condor_sysapi - Win32 Release" "condor_io - Win32 Release" "condor_util_lib - Win32 Release" "condor_cpp_util - Win32 Release" "$(OUTDIR)\condor_userlog.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"condor_cpp_util - Win32 ReleaseCLEAN" "condor_util_lib - Win32 ReleaseCLEAN" "condor_io - Win32 ReleaseCLEAN" "condor_sysapi - Win32 ReleaseCLEAN" "condor_classad - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\dc_stub.obj"
	...
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(OUTDIR)\condor_userlog.exe"
	-@erase "$(OUTDIR)\condor_userlog.map"
...
LINK32=link.exe
LINK32_FLAGS=../Release/condor_common.obj ../Release/condor_common_c.obj $(CONDOR_LIB) $(CONDOR_LIBPATH) $(CONDOR_GSOAP_LIB) $(CONDOR_GSOAP_LIBPATH) $(CONDOR_KERB_LIB) $(CONDOR_KERB_LIBPATH) $(CONDOR_PCRE_LIB) $(CONDOR_PCRE_LIBPATH) /nologo /subsystem:console /pdb:none /map:"$(INTDIR)\condor_userlog.map" /debug /machine:I386 /out:"$(OUTDIR)\condor_userlog.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dc_stub.obj" \
	"$(INTDIR)\userlog.obj" \
	"$(OUTDIR)\condor_cpp_util.lib" \
...
!IF EXISTS("condor_userlog.dep")
!INCLUDE "condor_userlog.dep"
!ELSE 
!MESSAGE Warning: cannot find "condor_userlog.dep"
!ENDIF 
!ENDIF 
...
SOURCE=..\src\condor_userlog\userlog.C

"$(INTDIR)\userlog.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\condor_common.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
