        ...
        #ifndef AviaryLocator_LOOKUP_H
        #define AviaryLocator_LOOKUP_H
...
namespace AviaryLocator
{
        ...
        private:
            ...
            std::vector<AviaryCommon::EndpointID*>* property_Ids;
        ...
        /**
         * Constructor for creating Lookup
         * @param 
         * @param Ids std::vector<AviaryCommon::EndpointID*>*
         * @param PartialMatches bool
         * @return newly created Lookup object
         */
        Lookup(std::vector<AviaryCommon::EndpointID*>* arg_Ids,bool arg_PartialMatches);
         ...
         * or addIds instead.
         * @param arg_Ids Array of AviaryCommon::EndpointID*s.
         * @return true on success, false otherwise
         */
        WSF_EXTERN bool WSF_CALL
        setIds(std::vector<AviaryCommon::EndpointID*>*  arg_Ids);
        ...
        * @param i index of the item to be obtained
         ...
         * @param arg_Ids element to set AviaryCommon::EndpointID* to the array
         * @return ith AviaryCommon::EndpointID* of the array
         */
        WSF_EXTERN bool WSF_CALL
        setIdsAt(int i,
        ...
        /**
         * Add to ids.
         * @param arg_Ids element to add AviaryCommon::EndpointID* to the array
         * @return true on success, false otherwise.
         */
        WSF_EXTERN bool WSF_CALL
        addIds(
       ...
       /**
         ...
         * @param Lookup_om_node node to serialize from
         * @param Lookup_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* Lookup_om_node, axiom_element_t *Lookup_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the Lookup is a particle class (E.g. group, inner sequence)
