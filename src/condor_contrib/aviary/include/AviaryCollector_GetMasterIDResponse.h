          ...
          #ifndef AviaryCollector_GETMASTERIDRESPONSE_H
          #define AviaryCollector_GETMASTERIDRESPONSE_H
        
      
       /**
        * GetMasterIDResponse.h
        *
       ...
       /**
        *  GetMasterIDResponse class
        */

        namespace AviaryCollector{
            class GetMasterIDResponse;
        }
...
namespace AviaryCollector
{
        ...
        /**
         * Constructor for class GetMasterIDResponse
         */

        GetMasterIDResponse();

        /**
         * Destructor GetMasterIDResponse
         */
        ~GetMasterIDResponse();
        ...
        /**
         * Constructor for creating GetMasterIDResponse
         * @param 
         * @param Results std::vector<AviaryCommon::Master*>*
         * @param Remaining int
         * @return newly created GetMasterIDResponse object
         */
        GetMasterIDResponse(std::vector<AviaryCommon::Master*>* arg_Results,int arg_Remaining);
        

        /**
         * resetAll for GetMasterIDResponse
         */
       ...
       /**
         ...
         * @param GetMasterIDResponse_om_node node to serialize from
         * @param GetMasterIDResponse_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* GetMasterIDResponse_om_node, axiom_element_t *GetMasterIDResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the GetMasterIDResponse is a particle class (E.g. group, inner sequence)
