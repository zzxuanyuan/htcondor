          ...
          #ifndef AviaryResource_GETATTRIBUTESRESPONSE_H
          #define AviaryResource_GETATTRIBUTESRESPONSE_H
...
namespace AviaryResource
{
        ...
        private:
            ...
            std::vector<AviaryResource::AttributeResponse*>* property_Results;
         ...
         * @param 
         * @param Results std::vector<AviaryResource::AttributeResponse*>*
         * @param Status AviaryCommon::Status*
         * @return newly created GetAttributesResponse object
         */
        GetAttributesResponse(std::vector<AviaryResource::AttributeResponse*>* arg_Results,AviaryCommon::Status* arg_Status);
         ...
         * @return Array of AviaryResource::AttributeResponse*s.
         */
        WSF_EXTERN std::vector<AviaryResource::AttributeResponse*>* WSF_CALL
        getResults();

        /**
         * Setter for results.Deprecated for array types, Use setResultsAt
         * or addResults instead.
         * @param arg_Results Array of AviaryResource::AttributeResponse*s.
         * @return true on success, false otherwise
         */
        WSF_EXTERN bool WSF_CALL
        setResults(std::vector<AviaryResource::AttributeResponse*>*  arg_Results);
        ...
        * @param i index of the item to be obtained
         * @return ith AviaryResource::AttributeResponse* of the array
         */
        WSF_EXTERN AviaryResource::AttributeResponse* WSF_CALL
        getResultsAt(int i);

        /**
         * Set the ith element of results. (If the ith already exist, it will be replaced)
         * @param i index of the item to return
         * @param arg_Results element to set AviaryResource::AttributeResponse* to the array
         * @return ith AviaryResource::AttributeResponse* of the array
         */
        WSF_EXTERN bool WSF_CALL
        setResultsAt(int i,
        ...
        /**
         * Add to results.
         * @param arg_Results element to add AviaryResource::AttributeResponse* to the array
         * @return true on success, false otherwise.
         */
        WSF_EXTERN bool WSF_CALL
        addResults(
       ...
       /**
         ...
         * @return Array of AviaryResource::AttributeResponses.
         */
