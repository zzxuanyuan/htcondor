          ...
          #ifndef AviaryCollector_GETSLOTID_H
          #define AviaryCollector_GETSLOTID_H
...
namespace AviaryCollector
{
        ...
        /**
         * Constructor for class GetSlotID
         */

        GetSlotID();

        /**
         * Destructor GetSlotID
         */
        ~GetSlotID();
        ...
        /**
         * Constructor for creating GetSlotID
         * @param 
         * @param Size int
         * @param Mode AviaryCommon::ScanMode*
         * @param Offset AviaryCommon::ResourceID*
         * @return newly created GetSlotID object
         */
        GetSlotID(int arg_Size,AviaryCommon::ScanMode* arg_Mode,AviaryCommon::ResourceID* arg_Offset);
        

        /**
         * resetAll for GetSlotID
         */
       ...
       /**
         ...
         * @param GetSlotID_om_node node to serialize from
         * @param GetSlotID_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* GetSlotID_om_node, axiom_element_t *GetSlotID_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the GetSlotID is a particle class (E.g. group, inner sequence)
