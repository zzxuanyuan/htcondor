          ...
          #ifndef AviaryCollector_GETSCHEDULERRESPONSE_H
          #define AviaryCollector_GETSCHEDULERRESPONSE_H
        
      
       /**
        * GetSchedulerResponse.h
        *
...
namespace AviaryCollector
{
        ...
        /**
         * Constructor for class GetSchedulerResponse
         */

        GetSchedulerResponse();

        /**
         * Destructor GetSchedulerResponse
         */
        ~GetSchedulerResponse();
        ...
        /**
         * resetAll for GetSchedulerResponse
         */
       ...
       /**
         ...
         * @param GetSchedulerResponse_om_node node to serialize from
         * @param GetSchedulerResponse_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* GetSchedulerResponse_om_node, axiom_element_t *GetSchedulerResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the GetSchedulerResponse is a particle class (E.g. group, inner sequence)
