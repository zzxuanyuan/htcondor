          ...
          #ifndef AviaryResource_GETATTRIBUTES_H
          #define AviaryResource_GETATTRIBUTES_H
...
namespace AviaryResource
{
        ...
        private:
            ...
            std::vector<AviaryResource::AttributeRequest*>* property_Ids;
         ...
         * @param 
         * @param Ids std::vector<AviaryResource::AttributeRequest*>*
         * @param ValuesOnly bool
         * @return newly created GetAttributes object
         */
        GetAttributes(std::vector<AviaryResource::AttributeRequest*>* arg_Ids,bool arg_ValuesOnly);
         ...
         * @return Array of AviaryResource::AttributeRequest*s.
         */
        WSF_EXTERN std::vector<AviaryResource::AttributeRequest*>* WSF_CALL
        getIds();

        /**
         * Setter for ids.Deprecated for array types, Use setIdsAt
         * or addIds instead.
         * @param arg_Ids Array of AviaryResource::AttributeRequest*s.
         * @return true on success, false otherwise
         */
        WSF_EXTERN bool WSF_CALL
        setIds(std::vector<AviaryResource::AttributeRequest*>*  arg_Ids);
        ...
        * @param i index of the item to be obtained
         * @return ith AviaryResource::AttributeRequest* of the array
         */
        WSF_EXTERN AviaryResource::AttributeRequest* WSF_CALL
        getIdsAt(int i);

        /**
         * Set the ith element of ids. (If the ith already exist, it will be replaced)
         * @param i index of the item to return
         * @param arg_Ids element to set AviaryResource::AttributeRequest* to the array
         * @return ith AviaryResource::AttributeRequest* of the array
         */
        WSF_EXTERN bool WSF_CALL
        setIdsAt(int i,
        ...
        /**
         * Add to ids.
         * @param arg_Ids element to add AviaryResource::AttributeRequest* to the array
         * @return true on success, false otherwise.
         */
        WSF_EXTERN bool WSF_CALL
        addIds(
       ...
       /**
         ...
         * @return Array of AviaryResource::AttributeRequests.
         */
