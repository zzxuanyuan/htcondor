          ...
          #ifndef AviaryCollector_GETNEGOTIATOR_H
          #define AviaryCollector_GETNEGOTIATOR_H
...
namespace AviaryCollector
{
        ...
        /**
         * Constructor for class GetNegotiator
         */

        GetNegotiator();

        /**
         * Destructor GetNegotiator
         */
        ~GetNegotiator();
        ...
        /**
         * Constructor for creating GetNegotiator
         * @param 
         * @param Ids std::vector<std::string*>*
         * @param PartialMatches bool
         * @param IncludeSummaries bool
         * @return newly created GetNegotiator object
         */
        GetNegotiator(std::vector<std::string*>* arg_Ids,bool arg_PartialMatches,bool arg_IncludeSummaries);
        

        /**
         * resetAll for GetNegotiator
         */
       ...
       /**
         ...
         * @param GetNegotiator_om_node node to serialize from
         * @param GetNegotiator_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* GetNegotiator_om_node, axiom_element_t *GetNegotiator_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the GetNegotiator is a particle class (E.g. group, inner sequence)
