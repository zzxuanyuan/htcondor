          ...
          #ifndef AviaryCommon_SCHEDULER_H
          #define AviaryCommon_SCHEDULER_H
...
namespace AviaryCommon
{
        ...
        private:
            ...
            AviaryCommon::Status* property_Status;
                ...
                bool isValidStatus;
            AviaryCommon::SchedulerSummary* property_Summary;
        ...
        /**
         * Constructor for creating Scheduler
         * @param 
         * @param Id AviaryCommon::ResourceID*
         * @param Status AviaryCommon::Status*
         * @param Summary AviaryCommon::SchedulerSummary*
         * @return newly created Scheduler object
         */
        Scheduler(AviaryCommon::ResourceID* arg_Id,AviaryCommon::Status* arg_Status,AviaryCommon::SchedulerSummary* arg_Summary);
        

        /**
         * resetAll for Scheduler
         */
        ...
        /**
         * Getter for summary. 
         * @return AviaryCommon::SchedulerSummary*
         */
        WSF_EXTERN AviaryCommon::SchedulerSummary* WSF_CALL
        getSummary();

        /**
         * Setter for summary.
         * @param arg_Summary AviaryCommon::SchedulerSummary*
         * @return true on success, false otherwise
         */
        WSF_EXTERN bool WSF_CALL
        setSummary(AviaryCommon::SchedulerSummary*  arg_Summary);
       ...
       /**
         ...
         * @param Scheduler_om_node node to serialize from
         * @param Scheduler_om_element parent element to serialize from
        ...
        serialize(axiom_node_t* Scheduler_om_node, axiom_element_t *Scheduler_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);

        /**
         * Check whether the Scheduler is a particle class (E.g. group, inner sequence)
        ...
        AviaryCommon::SchedulerSummary* WSF_CALL
        getProperty3();
