        ...
        using namespace AviaryLocator;
               ...
               /*
                * Implementation of the Lookup|http://locator.aviary.grid.redhat.com Element
                */
           AviaryLocator::Lookup::Lookup()
        {
       ...
       AviaryLocator::Lookup::Lookup(std::vector<AviaryCommon::EndpointID*>* arg_Ids,bool arg_PartialMatches)
        {
        ...
        bool WSF_CALL
        AviaryLocator::Lookup::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for Lookup : "
          ...
          bool WSF_CALL
          AviaryLocator::Lookup::isParticle()
          {
          ...
          void WSF_CALL
          AviaryLocator::Lookup::declareParentNamespaces(
	...
	AviaryLocator::Lookup::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "Lookup", ns1 , &parent);
                ...
                if(isValidPartialMatches)
                {
                   ...
                   else
                   {
                     ...
                     if (property_Ids != NULL)
                     {
                         ...
                         for(i = 0; i < count; i++)
                         {
                            AviaryCommon::EndpointID* element = (*property_Ids)[i];
            ...
            AviaryLocator::Lookup::getProperty1()
            {
                return getIds();
            }
             ...
             */
            bool WSF_CALL
            AviaryLocator::Lookup::setIds(
                    std::vector<AviaryCommon::EndpointID*>*  arg_Ids)
             {
            ...
            AviaryLocator::Lookup::getIdsAt(int i)
            {
             ...
             */
           bool WSF_CALL
            AviaryLocator::Lookup::setIdsAt(int i,
                    AviaryCommon::EndpointID* arg_Ids)
            {
                ...
                if(property_Ids == NULL)
                {
                    property_Ids = new std::vector<AviaryCommon::EndpointID*>();
                }
                else{
             ...
             */
            int WSF_CALL
            AviaryLocator::Lookup::sizeofIds()
            {
             ...
             */
            bool WSF_CALL
            AviaryLocator::Lookup::removeIdsAt(int i)
            {
           ...
           AviaryLocator::Lookup::resetIds()
           {
               ...
               int count = 0;
                ...
                if (property_Ids != NULL)
                {
                  std::vector<AviaryCommon::EndpointID*>::iterator it =  property_Ids->begin();
            ...
            */
           bool WSF_CALL
           AviaryLocator::Lookup::setIdsNil()
           {
               return resetIds();
           }
            ...
            */
           bool WSF_CALL
           AviaryLocator::Lookup::isIdsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryLocator::Lookup::setIdsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
             ...
             */
            bool WSF_CALL
            AviaryLocator::Lookup::getProperty2()
            {
             ...
             */
            bool WSF_CALL
            AviaryLocator::Lookup::getPartialMatches()
             {
             ...
             */
            bool WSF_CALL
            AviaryLocator::Lookup::setPartialMatches(
            ...
            */
           bool WSF_CALL
           AviaryLocator::Lookup::resetPartialMatches()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryLocator::Lookup::isPartialMatchesNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryLocator::Lookup::setPartialMatchesNil()
           {
