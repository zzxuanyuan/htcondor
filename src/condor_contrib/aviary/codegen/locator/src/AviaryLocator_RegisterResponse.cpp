        ...
        using namespace AviaryLocator;
               ...
               /*
                * Implementation of the RegisterResponse|http://locator.aviary.grid.redhat.com Element
                */
           AviaryLocator::RegisterResponse::RegisterResponse()
        {
       ...
       AviaryLocator::RegisterResponse::RegisterResponse(AviaryCommon::Status* arg_Status)
        {
        ...
        bool WSF_CALL
        AviaryLocator::RegisterResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for RegisterResponse : "
          ...
          bool WSF_CALL
          AviaryLocator::RegisterResponse::isParticle()
          {
          ...
          void WSF_CALL
          AviaryLocator::RegisterResponse::declareParentNamespaces(
	...
	AviaryLocator::RegisterResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "RegisterResponse", ns1 , &parent);
            ...
            AviaryLocator::RegisterResponse::getProperty1()
            {
                return getStatus();
            }
             ...
             */
            AviaryCommon::Status* WSF_CALL
            AviaryLocator::RegisterResponse::getStatus()
             {
             ...
             */
            bool WSF_CALL
            AviaryLocator::RegisterResponse::setStatus(
            ...
            */
           bool WSF_CALL
           AviaryLocator::RegisterResponse::resetStatus()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryLocator::RegisterResponse::isStatusNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryLocator::RegisterResponse::setStatusNil()
           {
               return resetStatus();
           }
