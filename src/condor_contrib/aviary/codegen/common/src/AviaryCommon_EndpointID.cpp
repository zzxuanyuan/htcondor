        ...
        using namespace AviaryCommon;
                 ...
                 */
           AviaryCommon::EndpointID::EndpointID()
        {
       ...
       AviaryCommon::EndpointID::EndpointID(AviaryCommon::ResourceType* arg_Type,std::string arg_Name,axutil_uri_t* arg_Url)
        {
        ...
        bool WSF_CALL
        AviaryCommon::EndpointID::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                  ...
                  if(element_qname)
                  {
                      ...
                      */
                                 ...
                                 element_qname = axutil_qname_create(Environment::getEnv(), "url", NULL, NULL);
                                 

                           if ( 
                                (current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("url", axiom_element_get_localname(current_element, Environment::getEnv())))))
                           {
                              if( current_node   && current_element && (axutil_qname_equals(element_qname, Environment::getEnv(), mqname) || !axutil_strcmp("url", axiom_element_get_localname(current_element, Environment::getEnv()))))
                              {
                                is_early_node_valid = true;
                              }
                                      ...
                                      if(text_value != NULL)
                                      {
                                          status = setUrl(axutil_uri_parse_string(Environment::getEnv(), text_value));
                                      }
                                      
                                      else
                                      {
                                          WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI, "NULL value is set to a non nillable element url");
                                          status = AXIS2_FAILURE;
                                      }
                                      
                                 if(AXIS2_FAILURE ==  status)
                                 {
                                     WSF_LOG_ERROR_MSG( Environment::getEnv()->log,WSF_LOG_SI,"failed in setting the value for url ");
                                     if(element_qname)
                                     {
                                         axutil_qname_free(element_qname, Environment::getEnv());
                                     }
          ...
          bool WSF_CALL
          AviaryCommon::EndpointID::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCommon::EndpointID::declareParentNamespaces(
	...
	AviaryCommon::EndpointID::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
			...
			int *next_ns_index)
        {
         ...
         int tag_closed = 0;
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_2 = (axis2_char_t*)property_Name.c_str();
                   ...
                   else
                   {
                      ...
                      */
                        ...
                        end_input_str_len = axutil_strlen(end_input_str);
                           ...
                           text_value_3 = axutil_uri_to_string(property_Url, Environment::getEnv(), AXIS2_URI_UNP_OMITUSERINFO);
            ...
            AviaryCommon::EndpointID::getProperty1()
            {
                return getType();
            }
             ...
             */
            AviaryCommon::ResourceType* WSF_CALL
            AviaryCommon::EndpointID::getType()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::EndpointID::setType(
                    AviaryCommon::ResourceType*  arg_Type)
             {
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::resetType()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::isTypeNil()
           {
               return !isValidType;
           }
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::setTypeNil()
           {
               return resetType();
           }
             ...
             */
            std::string WSF_CALL
            AviaryCommon::EndpointID::getProperty2()
            {
                return getName();
            }
             ...
             */
            std::string WSF_CALL
            AviaryCommon::EndpointID::getName()
             {
             ...
             */
            bool WSF_CALL
            AviaryCommon::EndpointID::setName(
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::resetName()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::isNameNil()
           {
               return !isValidName;
           }
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::setNameNil()
           {
               return resetName();
           }
            ...
            AviaryCommon::EndpointID::getProperty3()
            {
                return getUrl();
            }
             ...
             */
            axutil_uri_t* WSF_CALL
            AviaryCommon::EndpointID::getUrl()
             {
                return property_Url;
             }
             ...
             */
            bool WSF_CALL
            AviaryCommon::EndpointID::setUrl(
                    axutil_uri_t*  arg_Url)
             {
                

                if(isValidUrl &&
                        arg_Url == property_Url)
                {
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::resetUrl()
           {
               int i = 0;
               int count = 0;
                ...
                if(property_Url != NULL)
                {
                      ...
                      axutil_uri_free(property_Url, Environment::getEnv());
                         property_Url = NULL;
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::isUrlNil()
           {
               return !isValidUrl;
           }
            ...
            */
           bool WSF_CALL
           AviaryCommon::EndpointID::setUrlNil()
           {
               return resetUrl();
           }
