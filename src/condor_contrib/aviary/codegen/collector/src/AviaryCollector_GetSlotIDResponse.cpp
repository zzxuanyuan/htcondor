       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetSlotIDResponse|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetSlotIDResponse::GetSlotIDResponse()
        {
       ...
       AviaryCollector::GetSlotIDResponse::GetSlotIDResponse(std::vector<AviaryCommon::Slot*>* arg_Results,int arg_Remaining)
        {
        ...
        bool WSF_CALL AviaryCollector::GetSlotIDResponse::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryCollector::GetSlotIDResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetSlotIDResponse : "
          ...
          bool WSF_CALL
          AviaryCollector::GetSlotIDResponse::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetSlotIDResponse::declareParentNamespaces(
	...
	AviaryCollector::GetSlotIDResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetSlotIDResponse", ns1 , &parent);
            ...
            AviaryCollector::GetSlotIDResponse::getProperty1()
            {
                return getResults();
            }
             ...
             */
            std::vector<AviaryCommon::Slot*>* WSF_CALL
            AviaryCollector::GetSlotIDResponse::getResults()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotIDResponse::setResults(
            ...
            AviaryCollector::GetSlotIDResponse::getResultsAt(int i)
            {
             ...
             */
           bool WSF_CALL
            AviaryCollector::GetSlotIDResponse::setResultsAt(int i,
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotIDResponse::addResults(
                    AviaryCommon::Slot* arg_Results)
             {
             ...
             */
            int WSF_CALL
            AviaryCollector::GetSlotIDResponse::sizeofResults()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotIDResponse::removeResultsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotIDResponse::resetResults()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotIDResponse::isResultsNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotIDResponse::setResultsNil()
           {
               return resetResults();
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotIDResponse::isResultsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotIDResponse::setResultsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
             ...
             */
            int WSF_CALL
            AviaryCollector::GetSlotIDResponse::getProperty2()
            {
                return getRemaining();
            }
             ...
             */
            int WSF_CALL
            AviaryCollector::GetSlotIDResponse::getRemaining()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotIDResponse::setRemaining(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotIDResponse::resetRemaining()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotIDResponse::isRemainingNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotIDResponse::setRemainingNil()
           {
