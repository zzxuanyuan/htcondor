       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetMaster|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetMaster::GetMaster()
        {
       ...
       AviaryCollector::GetMaster::GetMaster(std::vector<std::string*>* arg_Ids,bool arg_PartialMatches,bool arg_IncludeSummaries)
        {
        ...
        bool WSF_CALL AviaryCollector::GetMaster::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryCollector::GetMaster::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetMaster : "
          ...
          bool WSF_CALL
          AviaryCollector::GetMaster::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetMaster::declareParentNamespaces(
	...
	AviaryCollector::GetMaster::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetMaster", ns1 , &parent);
            ...
            AviaryCollector::GetMaster::getProperty1()
            {
                return getIds();
            }
             ...
             */
            std::vector<std::string*>* WSF_CALL
            AviaryCollector::GetMaster::getIds()
             {
                return property_Ids;
             }
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::setIds(
             ...
             */
            std::string WSF_CALL
            AviaryCollector::GetMaster::getIdsAt(int i)
            {
                std::string* ret_val;
                if(property_Ids == NULL)
                {
             ...
             */
           bool WSF_CALL
            AviaryCollector::GetMaster::setIdsAt(int i,
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::addIds(
                    const std::string arg_Ids)
             {
             ...
             */
            int WSF_CALL
            AviaryCollector::GetMaster::sizeofIds()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::removeIdsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::resetIds()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::isIdsNil()
           {
               return !isValidIds;
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::setIdsNil()
           {
               return resetIds();
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::isIdsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::setIdsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::getProperty2()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::getPartialMatches()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::setPartialMatches(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::resetPartialMatches()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::isPartialMatchesNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::setPartialMatchesNil()
           {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::getProperty3()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::getIncludeSummaries()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMaster::setIncludeSummaries(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::resetIncludeSummaries()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::isIncludeSummariesNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMaster::setIncludeSummariesNil()
           {
