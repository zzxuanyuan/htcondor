       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetNegotiator|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetNegotiator::GetNegotiator()
        {
       ...
       AviaryCollector::GetNegotiator::GetNegotiator(std::vector<std::string*>* arg_Ids,bool arg_PartialMatches,bool arg_IncludeSummaries)
        {
        ...
        bool WSF_CALL AviaryCollector::GetNegotiator::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryCollector::GetNegotiator::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetNegotiator : "
          ...
          bool WSF_CALL
          AviaryCollector::GetNegotiator::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetNegotiator::declareParentNamespaces(
	...
	AviaryCollector::GetNegotiator::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetNegotiator", ns1 , &parent);
            ...
            AviaryCollector::GetNegotiator::getProperty1()
            {
                return getIds();
            }
             ...
             */
            std::vector<std::string*>* WSF_CALL
            AviaryCollector::GetNegotiator::getIds()
             {
                return property_Ids;
             }
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::setIds(
             ...
             */
            std::string WSF_CALL
            AviaryCollector::GetNegotiator::getIdsAt(int i)
            {
                std::string* ret_val;
                if(property_Ids == NULL)
                {
             ...
             */
           bool WSF_CALL
            AviaryCollector::GetNegotiator::setIdsAt(int i,
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::addIds(
                    const std::string arg_Ids)
             {
             ...
             */
            int WSF_CALL
            AviaryCollector::GetNegotiator::sizeofIds()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::removeIdsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::resetIds()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::isIdsNil()
           {
               return !isValidIds;
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::setIdsNil()
           {
               return resetIds();
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::isIdsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::setIdsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::getProperty2()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::getPartialMatches()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::setPartialMatches(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::resetPartialMatches()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::isPartialMatchesNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::setPartialMatchesNil()
           {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::getProperty3()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::getIncludeSummaries()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetNegotiator::setIncludeSummaries(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::resetIncludeSummaries()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::isIncludeSummariesNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetNegotiator::setIncludeSummariesNil()
           {
