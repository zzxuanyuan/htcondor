       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetMasterID|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetMasterID::GetMasterID()
        {
       ...
       AviaryCollector::GetMasterID::GetMasterID(int arg_Size,AviaryCommon::ScanMode* arg_Mode,AviaryCommon::ResourceID* arg_Offset)
        {
        ...
        bool WSF_CALL AviaryCollector::GetMasterID::resetAll()
        {
            //calls reset method for all the properties owned by this method which are pointers.

            
             resetMode();//AviaryCommon::ScanMode
             resetOffset();//AviaryCommon::ResourceID
          if(qname != NULL)
          {
        ...
        bool WSF_CALL
        AviaryCollector::GetMasterID::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetMasterID : "
          ...
          bool WSF_CALL
          AviaryCollector::GetMasterID::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetMasterID::declareParentNamespaces(
	...
	AviaryCollector::GetMasterID::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetMasterID", ns1 , &parent);
             ...
             */
            int WSF_CALL
            AviaryCollector::GetMasterID::getProperty1()
            {
                return getSize();
            }
             ...
             */
            int WSF_CALL
            AviaryCollector::GetMasterID::getSize()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMasterID::setSize(
                    const int  arg_Size)
             {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::resetSize()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::isSizeNil()
           {
               return !isValidSize;
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::setSizeNil()
           {
               return resetSize();
           }
            ...
            AviaryCollector::GetMasterID::getProperty2()
            {
                return getMode();
            }
             ...
             */
            AviaryCommon::ScanMode* WSF_CALL
            AviaryCollector::GetMasterID::getMode()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMasterID::setMode(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::resetMode()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::isModeNil()
           {
               return !isValidMode;
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::setModeNil()
           {
               return resetMode();
           }
            ...
            AviaryCollector::GetMasterID::getProperty3()
            {
                return getOffset();
            }
             ...
             */
            AviaryCommon::ResourceID* WSF_CALL
            AviaryCollector::GetMasterID::getOffset()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMasterID::setOffset(
                    AviaryCommon::ResourceID*  arg_Offset)
             {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::resetOffset()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::isOffsetNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterID::setOffsetNil()
           {
               return resetOffset();
           }
