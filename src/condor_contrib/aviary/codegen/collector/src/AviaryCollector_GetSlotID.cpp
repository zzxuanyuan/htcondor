       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetSlotID|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetSlotID::GetSlotID()
        {
       ...
       AviaryCollector::GetSlotID::GetSlotID(int arg_Size,AviaryCommon::ScanMode* arg_Mode,AviaryCommon::ResourceID* arg_Offset)
        {
        ...
        bool WSF_CALL AviaryCollector::GetSlotID::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryCollector::GetSlotID::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetSlotID : "
          ...
          bool WSF_CALL
          AviaryCollector::GetSlotID::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetSlotID::declareParentNamespaces(
	...
	AviaryCollector::GetSlotID::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetSlotID", ns1 , &parent);
             ...
             */
            int WSF_CALL
            AviaryCollector::GetSlotID::getProperty1()
            {
                return getSize();
            }
             ...
             */
            int WSF_CALL
            AviaryCollector::GetSlotID::getSize()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotID::setSize(
                    const int  arg_Size)
             {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::resetSize()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::isSizeNil()
           {
               return !isValidSize;
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::setSizeNil()
           {
               return resetSize();
           }
            ...
            AviaryCollector::GetSlotID::getProperty2()
            {
                return getMode();
            }
             ...
             */
            AviaryCommon::ScanMode* WSF_CALL
            AviaryCollector::GetSlotID::getMode()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotID::setMode(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::resetMode()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::isModeNil()
           {
               return !isValidMode;
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::setModeNil()
           {
               return resetMode();
           }
            ...
            AviaryCollector::GetSlotID::getProperty3()
            {
                return getOffset();
            }
             ...
             */
            AviaryCommon::ResourceID* WSF_CALL
            AviaryCollector::GetSlotID::getOffset()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlotID::setOffset(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::resetOffset()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::isOffsetNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlotID::setOffsetNil()
           {
               return resetOffset();
           }
