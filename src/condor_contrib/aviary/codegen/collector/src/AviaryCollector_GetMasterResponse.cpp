       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetMasterResponse|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetMasterResponse::GetMasterResponse()
        {
       ...
       AviaryCollector::GetMasterResponse::GetMasterResponse(std::vector<AviaryCommon::Master*>* arg_Results)
        {
        ...
        bool WSF_CALL AviaryCollector::GetMasterResponse::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryCollector::GetMasterResponse::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetMasterResponse : "
          ...
          bool WSF_CALL
          AviaryCollector::GetMasterResponse::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetMasterResponse::declareParentNamespaces(
	...
	AviaryCollector::GetMasterResponse::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetMasterResponse", ns1 , &parent);
            ...
            AviaryCollector::GetMasterResponse::getProperty1()
            {
                return getResults();
            }
             ...
             */
            std::vector<AviaryCommon::Master*>* WSF_CALL
            AviaryCollector::GetMasterResponse::getResults()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMasterResponse::setResults(
            ...
            AviaryCollector::GetMasterResponse::getResultsAt(int i)
            {
             ...
             */
           bool WSF_CALL
            AviaryCollector::GetMasterResponse::setResultsAt(int i,
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMasterResponse::addResults(
                    AviaryCommon::Master* arg_Results)
             {
             ...
             */
            int WSF_CALL
            AviaryCollector::GetMasterResponse::sizeofResults()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetMasterResponse::removeResultsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterResponse::resetResults()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterResponse::isResultsNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterResponse::setResultsNil()
           {
               return resetResults();
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterResponse::isResultsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetMasterResponse::setResultsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
