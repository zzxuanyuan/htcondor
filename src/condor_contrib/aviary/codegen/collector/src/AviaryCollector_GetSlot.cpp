       ...
       # endif
        ...
        using namespace AviaryCollector;
               ...
               /*
                * Implementation of the GetSlot|http://collector.aviary.grid.redhat.com Element
                */
           AviaryCollector::GetSlot::GetSlot()
        {
       ...
       AviaryCollector::GetSlot::GetSlot(std::vector<std::string*>* arg_Ids,bool arg_PartialMatches,bool arg_IncludeSummaries,bool arg_IncludeDynamic)
        {
            ...
            isValidIncludeDynamic  = true;
                 ...
                 qname =  axutil_qname_create (Environment::getEnv(),
                    ...
                    property_IncludeDynamic = arg_IncludeDynamic;
        ...
        bool WSF_CALL AviaryCollector::GetSlot::resetAll()
        {
        ...
        bool WSF_CALL
        AviaryCollector::GetSlot::deserialize(axiom_node_t** dp_parent,bool *dp_is_early_node_valid, bool dont_care_minoccurs)
        {
         ...
         axutil_qname_t *mqname = NULL;
                ...
                return AXIS2_FAILURE;
                    ...
                    else
                    {
                        WSF_LOG_ERROR_MSG(Environment::getEnv()->log, WSF_LOG_SI,
                              "Failed in building adb object for GetSlot : "
                 ...
                 attribute_hash = axiom_element_get_all_attributes(parent_element, Environment::getEnv());
                  ...
                  if(attribute_hash)
                  {
                       ...
                       for (hi = axutil_hash_first(attribute_hash, Environment::getEnv()); hi; hi = axutil_hash_next(Environment::getEnv(), hi))
                       {
                           axutil_hash_this(hi, &key, NULL, &val);
                               ...
                               if(!strcmp((axis2_char_t*)key, "includeDynamic"))
                  ...
                  {
                    /* this is hoping that attribute is stored in "includeDynamic", this happnes when name is in default namespace */
                    attrib_text = axiom_element_get_attribute_value_by_name(parent_element, Environment::getEnv(), "includeDynamic");
                  }
                  ...
                  if(attrib_text != NULL)
                  {
                           ...
                           if (!axutil_strcmp(attrib_text, "TRUE") || !axutil_strcmp(attrib_text, "true"))
                           {
                               setIncludeDynamic(true);
                           }
                           else
                           {
                               setIncludeDynamic(false);
                           }
          ...
          bool WSF_CALL
          AviaryCollector::GetSlot::isParticle()
          {
          ...
          void WSF_CALL
          AviaryCollector::GetSlot::declareParentNamespaces(
	...
	AviaryCollector::GetSlot::serialize(axiom_node_t *parent, 
			axiom_element_t *parent_element, 
         ...
         int tag_closed = 0;
               ...
               axutil_stream_t *stream = NULL;
                ...
                int next_ns_index_value = 0;
                    ...
                    parent_element = axiom_element_create (Environment::getEnv(), NULL, "GetSlot", ns1 , &parent);
            ...
            if(!parent_tag_closed)
            {
                ...
                if(isValidIncludeDynamic)
                {
                
                        p_prefix = NULL;
                      
                           
                           text_value = (axis2_char_t*)((property_IncludeDynamic)?"true":"false");
                           string_to_stream = (axis2_char_t*) AXIS2_MALLOC (Environment::getEnv()-> allocator, sizeof (axis2_char_t) *
                                                            (5  + ADB_DEFAULT_NAMESPACE_PREFIX_LIMIT +
                                                             axutil_strlen(text_value) + 
                                                             axutil_strlen("includeDynamic")));
                           sprintf(string_to_stream, " %s%s%s=\"%s\"", p_prefix?p_prefix:"", (p_prefix && axutil_strcmp(p_prefix, ""))?":":"",
                                                "includeDynamic",  text_value);
                           axutil_stream_write(stream, Environment::getEnv(), string_to_stream, axutil_strlen(string_to_stream));
                           AXIS2_FREE(Environment::getEnv()-> allocator, string_to_stream);
                   ...
                   else
                   {
                    ...
                    if(parent_tag_closed)
                    {
                       if(isValidIncludeDynamic)
                       {
                           ...
                           text_value =  (axis2_char_t*)((property_IncludeDynamic)?axutil_strdup(Environment::getEnv(), "true"):axutil_strdup(Environment::getEnv(), "false"));
                           text_attri = axiom_attribute_create (Environment::getEnv(), "includeDynamic", text_value, ns1);
                           axiom_element_add_attribute (parent_element, Environment::getEnv(), text_attri, parent);
                           AXIS2_FREE(Environment::getEnv()->allocator, text_value);
            ...
            AviaryCollector::GetSlot::getProperty1()
            {
                return getIds();
            }
             ...
             */
            std::vector<std::string*>* WSF_CALL
            AviaryCollector::GetSlot::getIds()
             {
                return property_Ids;
             }
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::setIds(
             ...
             */
            std::string WSF_CALL
            AviaryCollector::GetSlot::getIdsAt(int i)
            {
                std::string* ret_val;
                if(property_Ids == NULL)
                {
             ...
             */
           bool WSF_CALL
            AviaryCollector::GetSlot::setIdsAt(int i,
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::addIds(
                    const std::string arg_Ids)
             {
             ...
             */
            int WSF_CALL
            AviaryCollector::GetSlot::sizeofIds()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::removeIdsAt(int i)
            {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::resetIds()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::isIdsNil()
           {
               return !isValidIds;
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::setIdsNil()
           {
               return resetIds();
           }
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::isIdsNilAt(int i)
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::setIdsNilAt(int i)
           {
                int size = 0;
                int j;
                bool non_nil_exists = false;
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::getProperty2()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::getPartialMatches()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::setPartialMatches(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::resetPartialMatches()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::isPartialMatchesNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::setPartialMatchesNil()
           {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::getProperty3()
            {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::getIncludeSummaries()
             {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::setIncludeSummaries(
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::resetIncludeSummaries()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::isIncludeSummariesNil()
           {
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::setIncludeSummariesNil()
           {
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::getProperty4()
            {
                return getIncludeDynamic();
            }
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::getIncludeDynamic()
             {
                return property_IncludeDynamic;
             }
             ...
             */
            bool WSF_CALL
            AviaryCollector::GetSlot::setIncludeDynamic(
                    bool  arg_IncludeDynamic)
             {
                

                if(isValidIncludeDynamic &&
                        arg_IncludeDynamic == property_IncludeDynamic)
                {
           ...
           /**
            * resetter for includeDynamic
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::resetIncludeDynamic()
           {
               int i = 0;
               int count = 0;
            ...
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::isIncludeDynamicNil()
           {
               return !isValidIncludeDynamic;
           }

           /**
            * Set includeDynamic to nill (currently the same as reset)
            */
           bool WSF_CALL
           AviaryCollector::GetSlot::setIncludeDynamicNil()
           {
               return resetIncludeDynamic();
           }
