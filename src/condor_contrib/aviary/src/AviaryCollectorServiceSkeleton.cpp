    ...
    /**
     * AviaryCollectorServiceSkeleton.cpp
     *
     ...
     * AviaryCollectorServiceSkeleton WSF/CPP Skeleton For the Service
     */
    ...
    using namespace com_redhat_grid_aviary_collector;
         ...
         */
        AviaryCollector::GetNegotiatorResponse* AviaryCollectorServiceSkeleton::getNegotiator(wso2wsf::MessageContext *outCtx ,AviaryCollector::GetNegotiator* _getNegotiator)

        {
          /* TODO fill this with the necessary business logic */
          return (AviaryCollector::GetNegotiatorResponse*)NULL;
        }
         ...
         */
        AviaryCollector::GetSubmitterResponse* AviaryCollectorServiceSkeleton::getSubmitter(wso2wsf::MessageContext *outCtx ,AviaryCollector::GetSubmitter* _getSubmitter)

        {
          /* TODO fill this with the necessary business logic */
          return (AviaryCollector::GetSubmitterResponse*)NULL;
        }
         ...
         */
        AviaryCollector::GetSlotResponse* AviaryCollectorServiceSkeleton::getSlot(wso2wsf::MessageContext *outCtx ,AviaryCollector::GetSlot* _getSlot)
         ...
         */
        AviaryCollector::GetSchedulerResponse* AviaryCollectorServiceSkeleton::getScheduler(wso2wsf::MessageContext *outCtx ,AviaryCollector::GetScheduler* _getScheduler)

        {
          /* TODO fill this with the necessary business logic */
          return (AviaryCollector::GetSchedulerResponse*)NULL;
        }
         ...
         */
        AviaryCollector::GetCollectorResponse* AviaryCollectorServiceSkeleton::getCollector(wso2wsf::MessageContext *outCtx ,AviaryCollector::GetCollector* _getCollector)
         ...
         */
        AviaryCollector::GetMasterResponse* AviaryCollectorServiceSkeleton::getMaster(wso2wsf::MessageContext *outCtx ,AviaryCollector::GetMaster* _getMaster)

        {
          /* TODO fill this with the necessary business logic */
          return (AviaryCollector::GetMasterResponse*)NULL;
        }
