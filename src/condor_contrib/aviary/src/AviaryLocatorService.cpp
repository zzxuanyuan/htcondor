	...
	AviaryLocatorService::invoke(OMElement *omEle, MessageContext *msgCtx)
	{
          ...
          */
          ...
          axiom_node_t* content_node = omEle->getAxiomNode();
            ...
            AviaryLocator::RegisterResponse* ret_val1;
            AviaryLocator::Register* input_val1;
            
            AviaryLocator::LookupResponse* ret_val2;
            AviaryLocator::Lookup* input_val2;
          ...
          if (op_name)
          {
                ...
                if ( axutil_strcmp(op_name, "register") == 0 )
                {

                    
                    input_val1 =
                        
                        new AviaryLocator::Register();
                        if( AXIS2_FAILURE ==  input_val1->deserialize(&content_node, NULL, false))
                        {
                            ...
                            AXIS2_LOG_ERROR( Environment::getEnv()->log, AXIS2_LOG_SI, "NULL returned from the AviaryLocator::Register_deserialize: "
                                        "This should be due to an invalid XML");
                            return NULL;      
                        }
                        
                        //AviaryLocatorServiceSkeleton skel;
                        ret_val1 =  skel->_register(msgCtx ,input_val1);
                ...
                if ( axutil_strcmp(op_name, "lookup") == 0 )
                {

                    
                    input_val2 =
                        
                        new AviaryLocator::Lookup();
                        if( AXIS2_FAILURE ==  input_val2->deserialize(&content_node, NULL, false))
                        {
                                        
                            AXIS2_ERROR_SET(Environment::getEnv()->error, AXIS2_ERROR_DATA_ELEMENT_IS_NULL, AXIS2_FAILURE);
                            AXIS2_LOG_ERROR( Environment::getEnv()->log, AXIS2_LOG_SI, "NULL returned from the AviaryLocator::Lookup_deserialize: "
                                        "This should be due to an invalid XML");
                            return NULL;      
                        }
                        
                        //AviaryLocatorServiceSkeleton skel;
                        ret_val2 =  skel->lookup(msgCtx ,input_val2);
