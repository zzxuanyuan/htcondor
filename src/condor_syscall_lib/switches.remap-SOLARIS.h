...
REMAP_SIX( mmap, _mmap, MMAP_T, MMAP_T, size_t, int, int, int, off_t )
REMAP_SIX( mount, _mount, int , const char *, const char *, int , int , char *, int )
REMAP_THREE( mprotect, _mprotect, int , MMAP_T, size_t , int )
REMAP_TWO( munmap, _munmap, int , MMAP_T, size_t )
