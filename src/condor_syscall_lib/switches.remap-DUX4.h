...
REMAP_THREE( ioctl, __ioctl, int , int , int , int)
...
REMAP_FOUR( getdirentries, __getdirentries, int , int , struct dirent *, int , long *)
...
REMAP_THREE( madvise, __madvise, int , char *, size_t , int )
REMAP_TWO( mkdir, __mkdir, int , const char *, unsigned int )
REMAP_THREE( mknod, __mknod, int , const char *, int , dev_t )
REMAP_SIX( mmap, __mmap, void * , void *, size_t , int , int , int , off_t )
REMAP_FOUR( mount, __mount, int , int , char *, int , char *)
...
REMAP_FOUR( msgsnd, __msgsnd, int , int , void *, size_t , int )
...
REMAP_THREE( readv, __readv, ssize_t, int, struct iovec *, int )
...
REMAP_THREE( shmat, __shmat, char * , int , char *, int )
REMAP_THREE( shmctl, __shmctl, int , int , int , struct shmid_ds *)
REMAP_ONE( shmdt, __shmdt, int , char *)
...
REMAP_THREE( statfs, __statfs, int , char *, struct statfs *, int )
     // REMAP_FOUR( swapon, __swapon, int , char *, int , int , int )
...
REMAP_THREE( writev, __writev, ssize_t, int, struct iovec *, int )
