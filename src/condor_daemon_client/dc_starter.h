...
public:
	...
	bool peek(bool transfer_stdout, bool transfer_stderr, const std::vector<std::string> &filenames, size_t max_bytes, bool &retry_sensible, PeekGetFD &next, std::string &, unsigned, const std::string &);
