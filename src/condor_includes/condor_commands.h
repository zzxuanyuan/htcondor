...
/*
*** Commands used by the cached daemon
*/
#define CACHED_BASE 76000
#define CACHED_CREATE_CACHE_DIR (CACHED_BASE+0)
#define CACHED_UPLOAD_FILES (CACHED_BASE+1)
#define CACHED_DOWNLOAD_FILES (CACHED_BASE+2)
#define CACHED_REMOVE_CACHE_DIR (CACHED_BASE+3)
#define CACHED_UPDATE_LEASE (CACHED_BASE+4)
#define CACHED_LIST_CACHE_DIRS (CACHED_BASE+5)
#define CACHED_LIST_FILES_BY_PATH (CACHED_BASE+6)
#define CACHED_CHECK_CONSISTENCY (CACHED_BASE+7)
#define CACHED_SET_REPLICATION_POLICY (CACHED_BASE+8)
#define CACHED_GET_REPLICATION_POLICY (CACHED_BASE+9)
#define CACHED_CREATE_REPLICA (CACHED_BASE+10)
#define CACHED_REPLICA_DOWNLOAD_FILES (CACHED_BASE+11)
#define CACHED_ADVERTISE_TO_ORIGIN (CACHED_BASE+12)
#define CACHED_REQUEST_LOCAL_REPLICATION (CACHED_BASE+13)
#define CACHED_ENCODE_DIR (CACHED_BASE+14)
#define CACHED_ENCODE_FILE (CACHED_BASE+15)
#define CACHED_DECODE_FILE (CACHED_BASE+16)
#define CACHED_DISTRIBUTE_ENCODED_FILES (CACHED_BASE+17)
#define CACHED_LIST_CACHEDS (CACHED_BASE+18)
...
#define CACHED_CREATE_CACHE_DIR2 (CACHED_BASE+24)
#define CACHED_ADVERTISE_REDUNDANCY (CACHED_BASE+25)
#define CACHED_LINK_CACHE_DIR (CACHED_BASE+26)
#define CACHED_PROBE_CACHED_SERVER (CACHED_BASE+27)
#define CACHED_REQUEST_REDUNDANCY (CACHED_BASE+28)
#define CACHED_PROCESS_TASK (CACHED_BASE+29)
#define CACHED_PROCESS_DATA_TASK (CACHED_BASE+30)
#define CACHED_INITIALIZE_CACHE (CACHED_BASE+31)
#define CACHED_DOWNLOAD_REDUNDANCY (CACHED_BASE+32)
#define CACHED_CLEAN_REDUNDANCY_SOURCE (CACHED_BASE+33)
#define CACHED_REQUEST_RECOVERY (CACHED_BASE+34)
#define CACHED_UPDATE_RECOVERY (CACHED_BASE+35)
#define CACHED_PROBE_CACHED_CLIENT (CACHED_BASE+36)
#define CACHED_GET_MOST_RELIABLE_CACHED (CACHED_BASE+37)
/*
...
#define STORAGE_OPTIMIZER_GET_CACHED_INFO (STORAGE_OPTIMIZER_BASE+1)
#define STORAGE_OPTIMIZER_LIST_STORAGE_OPTIMIZERS (STORAGE_OPTIMIZER_BASE+2)
