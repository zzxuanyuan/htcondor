...
#define DC_INVALIDATE_KEY   (DC_BASE+12)
...
#define GRIDMAN_SUBMIT_JOB (DCGRIDMANAGER_BASE+0)
#define GRIDMAN_CANCEL_JOB (DCGRIDMANAGER_BASE+1)
#define GRIDMAN_COMMIT_JOB (DCGRIDMANAGER_BASE+2)
#define GRIDMAN_RESTART_JM (DCGRIDMANAGER_BASE+3)
