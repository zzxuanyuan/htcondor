...
#define REPLICATION_FILESET_DATA           (REPLICATION_COMMANDS_BASE + 6)
#define REPLICATION_TRANSFER_REQUEST       (REPLICATION_COMMANDS_BASE + 7)
#define REPLICATION_TRANSFER_FILE_DATA     (REPLICATION_COMMANDS_BASE + 8)
#define REPLICATION_TRANSFER_NAK           (REPLICATION_COMMANDS_BASE + 9)
#define REPLICATION_TRANSFER_COMPLETE      (REPLICATION_COMMANDS_BASE + 10)
