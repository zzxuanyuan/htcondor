...
#define REPLICATION_NEWLY_JOINED_FINISHED  (REPLICATION_COMMANDS_BASE + 6)
...
const int UPDATE_REPLICATION_AD = 60;
const int QUERY_REPLICATION_ADS = 61;
const int INVALIDATE_REPLICATION_ADS = 62;
/*
*** Daemon Core Signals
*/
