...
extern const char * const  ATTR_SHADOW_INVALID_REQUEST;
extern const char * const  ATTR_SHADOW_INVALID_REASON;
extern const char * const  ATTR_SHADOW_RESULT;
extern const char * const  ATTR_SHADOW_SIGNAL;
