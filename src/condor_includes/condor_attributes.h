...
#define ATTR_USER_STAGEOUT_START "UserStageOutStart"
#define ATTR_USER_STAGEOUT_USER_CPU "UserStageOutUserCpu"
#define ATTR_USER_STAGEOUT_SYS_CPU "UserStageOutSysCpu"
