...
const char ATTR_IS_MATCHMAKER		 [] = "IsMatchmaker";  //JEFF
const char ATTR_NO_MATCH_COUNT		 [] = "NoMatchCount";  //JEFF
const char ATTR_IS_SOFT			 [] = "IsSoft";	//JEFF
const char ATTR_CHILD_POOL		 [] = "ChildPool"; //JEFF
const char ATTR_REMOVE_ME		 [] = "RemoveMe"; //JEFF
