...
const char ATTR_ERROR_ACTION             [] = "ErrorAction";
const char ATTR_ERROR_REASON			 [] = "ErrorReason";
const char ATTR_ERROR_REASON_CODE		 [] = "ErrorReasonCode";
const char ATTR_ERROR_REASON_SUBCODE	 [] = "ErrorReasonSubCode";
const char ATTR_ERROR_ACTION_DEFAULT	 [] = "ErrorActionDefault";
...
const char ATTR_LAST_ERROR_REASON        [] = "LastErrorReason";
const char ATTR_LAST_ERROR_REASON_CODE	 [] = "LastErrorReasonCode";
const char ATTR_LAST_ERROR_REASON_SUBCODE[] = "LastErrorReasonSubCode";
const char ATTR_LAST_ERROR_ACTION_DEFAULT[] = "LastErrorActionDefault";
