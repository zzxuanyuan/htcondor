...
bool
makeCreddAdHashKey (AdNameHashKey &hk, ClassAd *ad, sockaddr_in *from)
{
	hk.ip_addr = "";
	return adLookup( "CREDD", ad, ATTR_NAME, NULL, hk.name );
}

bool 
makeMinicaAdHashKey (AdNameHashKey &hk, ClassAd *ad, sockaddr_in *from)
{
	hk.ip_addr = "";
	return adLookup( "MINICA", ad, ATTR_NAME, NULL, hk.name );
}
