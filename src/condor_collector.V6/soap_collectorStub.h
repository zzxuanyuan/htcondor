...
{
	struct condorCore__ClassAdStruct ad;	/* return */
};
...
SOAP_FMAC5 int SOAP_FMAC6 condorCore__getInfoAd(struct soap*, void *, struct condorCore__ClassAdStruct &);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_condorCore__getInfoAd(struct soap*, const char*, const char*, void *, struct condorCore__ClassAdStruct &);
