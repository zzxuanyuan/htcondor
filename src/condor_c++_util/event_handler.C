...
#if (defined(LINUX) && (defined(GLIBC22) || defined(GLIBC23))) || defined(AIX) || defined(HPUX11) || defined(CONDOR_FREEBSD4) || defined(CONDOR_FREEBSD5) || defined(CONDOR_FREEBSD6) || defined(CONDOR_FREEBSD7)
