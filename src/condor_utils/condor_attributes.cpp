...
const char * const ATTR_SHADOW_INVALID_REQUEST	= "ShadowInvalidRequest";
const char * const ATTR_SHADOW_INVALID_REASON	= "ShadowInvalidRequestReason";
const char * const ATTR_SHADOW_RESULT		= "ShadowResult";
const char * const ATTR_SHADOW_SIGNAL		= "ShadowSignal";
