...
DROP TABLE Schedds_Horizontal;
DROP TABLE Schedds_Vertical;
DROP TABLE Schedds_Horizontal_History;
DROP TABLE Schedds_Vertical_History;
DROP TABLE Masters_Vertical;
DROP TABLE Masters_Vertical_History;
DROP TABLE Negotiators_Vertical;
DROP TABLE Negotiators_Vertical_History;
