...
// HACK for testing
const int DCJOBOPT_SPIN_BEFORE_EXEC = (1<<3);
#define HAS_DCJOBOPT_SPIN_BEFORE_EXEC(mask) ((mask)&DCJOBOPT_SPIN_BEFORE_EXEC)

// HACK for paradyn demo
const int DCJOBOPT_DONT_CLOSE_THREE = (1<<4);
#define HAS_DCJOBOPT_DONT_CLOSE_THREE(mask) ((mask)&DCJOBOPT_DONT_CLOSE_THREE)
