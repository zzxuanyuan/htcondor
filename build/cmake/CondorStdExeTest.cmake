...
MACRO (CONDOR_STD_EXE_TEST _CNDR_TARGET _COMPILER _SRCS _LINK_FLAGS )
	...
	if (STD_UNIVERSE AND BUILD_TESTS)
		...
		command_target( cc_${_CNDR_TARGET} ${CONDOR_COMPILE} "-condor_lib;${STDU_LIB_LOC};-condor_ld_dir;${STDU_LIB_LOC};${_COMPILER};-o;${_CNDR_TARGET}.cndr.exe;lib${_CNDR_TARGET}.a;${_LINK_FLAGS}" "${_CNDR_TARGET}.cndr.exe" )
		add_dependencies( cc_${_CNDR_TARGET} ${_CNDR_TARGET})
		...
		set_target_properties( cc_${_CNDR_TARGET} ca_${_CNDR_TARGET} PROPERTIES EXCLUDE_FROM_ALL TRUE)
