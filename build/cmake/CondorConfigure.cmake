...
if (LINUX OR DARWIN)
  if (LINUX)
    ...
    set (CONDOR_LIBS_FOR_SHADOW "condor_utils;classads;${SECURITY_LIBS};${RT_FOUND};${PCRE_FOUND};${OPENSSL_FOUND};${KRB5_FOUND};${POSTGRESQL_FOUND};${COREDUMPER_FOUND};${IOKIT_FOUND};${COREFOUNDATION_FOUND};resolv")
  endif ()
else ()
